...
for model_ in ["age", "gender"]:
    model = ResMLP(**read_json(f"/Users/kethanpabbi/Desktop/Thesis/YouTube-Gender-Prediction-Using-Faces/Data/Gender Detection/age-gender-main/models/{model_}.json")["arch"]["args"])
    checkpoint = f"/Users/kethanpabbi/Desktop/Thesis/YouTube-Gender-Prediction-Using-Faces/Data/Gender Detection/age-gender-main/models/{model_}.pth"
